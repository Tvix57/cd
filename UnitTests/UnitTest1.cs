...
namespace UnitTests
{
    public class UnitTest1
    {
        ...
        public void Test3()
        {
        string test1 = "1.23+2.23";
        Model m = new Model(test1);
        ...
        public void Test5()
        {
        string test3 = "100.456";
        Model m = new Model(test3);
        ...
        public void Test6()
        {
        string test4 = "(100.456)";
        Model m = new Model(test4);
        ...
        public void Test7()
        {
        string test5 = "2.1/(1.5+1.678)";
        Model m = new Model(test5);
        ...
        public void Test8()
        {
        string test6 = "2.7856*(5.345-2.345)";
        Model m = new Model(test6);
        ...
        public void Test9()
        {
        string test7 = "2.25*(5.67-2.543)";
        Model m = new Model(test7);
        ...
        public void Test10()
        {
        string test8 = "(2^2)+(2^2)";
        Model m = new Model(test8);
        ...
        public void Test11()
        {
        string test9 = "(2^2)^(2^2)";
        Model m = new Model(test9);
        ...
        public void Test13()
        {
        string test11 = "(sqrt(4))";
        Model m = new Model(test11);
    ...
    public void Test16()
    {
        string test14 = "((((10.987))))";
        Model m = new Model(test14);
...
public void Test17()
    {
        string test15 = "sqrt(9)";
        Model m = new Model(test15);
...
public void Test18()
    {
        string test16 = "10mod5";
        Model m = new Model(test16);
...
public void Test19()
    {
        string test17 = "log(10)";
        Model m = new Model(test17);
        ...
        public void Test20()
    {
        string test18 = "ln(2.718281828459045)";
        Model m = new Model(test18);
...
public void Test21()
    {
        string test19 = "log(-10)";
        Model m = new Model(test19);
...
public void Test23()
    {
        string test21 = "sqrt(-10)";
        Model m = new Model(test21);
...
public void Test24()
    {
        string test22 = "(-sqrt(2))";
        Model m = new Model(test22);
    ...
    [Fact] 
        public void Test28()
    {
        string test24 = "5.25-10.01";
        Model m = new Model(test24);
    ...
    {
        string test26 = "9.45/3.26";
        Model m = new Model(test26);
    ...
    {
        string test25 = "2^(3+4*5)*(2*2)+2+6/3";
        Model m = new Model(test25); //// 2 3 4 5 * + ^ 2 2 * * 2 + 6 3 / +
        double r25 = m.Calculate();
    ...
    {
        string test25 = "sin(2-1)*2^2+6^2*2";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    {
        string test25 = "(-2^(3+4*5)*(2*2)+2+6/3)";  //// 2 3 4 5 * + ^ 2 2 * * - 2 + 6 3 / +
        Model m = new Model(test25);
        double r25 = m.Calculate();
        double cp25 = -33554428;
        Assert.Equal(r25, cp25, 6);
    ...
    {
        string test25 = "56+21-376+(56-22)-(13+10)+(11+(7-(3+2)))";
        Model m = new Model(test25);  /// 56 21 + 376 - 56 22 - + 13 10 + - 11 7 3 2 + - + +
        double standart = -275;
        double res = m.Calculate();
        Assert.Equal(res, standart, 6);
    }
    ...
    {
        string test25 = "tan(10)*((5-3)*ln(4)-log(8))*2+7";
        Model m = new Model(test25);
    ...
    [Fact] public void Test54()
    {
        string test25 = "12+0.0";
        Model m = new Model(test25);
        double r25 = m.Calculate();
        double cp25 = 12;
        Assert.Equal(r25, cp25, 6);
    ...
    [Fact] public void Test55()
    {
        string test25 = "(-12+2.34";
        Model m = new Model(test25);
        double r25 = m.Calculate();
        double cp25 = -12 + 2.34;
        Assert.Equal(r25, cp25, 6);
    ...
    [Fact] public void Test56()
    {
        string test25 = "100+(-234.";
        Model m = new Model(test25);
        double r25 = m.Calculate();
        double cp25 = 100 + -234;
        Assert.Equal(r25, cp25, 6);
     ...
     [Fact] public void Test57()
    {
        string test25 = "9+(8+6)+1+(3+9)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test58()
    {
        string test25 = "21892683+(-60607476)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test59()
    {
        string test25 = "416-434-(190-490)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test60()
    {
        string test25 = "107-(928-166-438)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test61()
    {
        string test25 = "(399-985)-63-352";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test62()
    {
        string test25 = "10.7-(0.98-166-438)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test63()
    {
        string test25 = "10-(-928-16.6-438)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test65()
    {
        string test25 = "317-141-(118-695)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test66()
    {
        string test25 = "(3879294-5309583)-(3744311-2467480-4787696)-3324295";
        Model m = new Model(test25); //// 3879294 5309583 - 3744311 2467480 - 4787696 - - 3324295 -
        double r25 = m.Calculate();
    ...
    [Fact] public void Test67()
    {
        string test25 = "(-0.38227*7856.815-0.)*(7759.3*(-51507.96))";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test70()
    {
        string test25 = "(91.226*(-51.9))*(7.797*85.481)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test71()
    {
        string test25 = "(-25.9655*(-(-626.93*508.657)*(85.108*400.162))";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test72()
    {
        string test25 = "(-(-356.081*4598.63)*803.928*(70.592*0.1569)*(-36.1566)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test74()
    {
        string test25 = "(432/9.57/321)/(76.4/78.0)/(-35.8";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test75()
    {
        string test25 = "43.1/(495.5/711.)/28.7";
        Model m = new Model(test25);  //// 43.1 495.5 711. / / 28.7 /
        double r25 = m.Calculate();
    ...
    [Fact] public void Test76()
    {
        string test25 = "(0.5757/23.3/704.1/(-31.27)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
     ...
     [Fact] public void Test77()
    {
        string test25 = "(1.375/930.0)/223.3/80.41";
        Model m = new Model(test25);
        double r25 = m.Calculate();
     ...
     [Fact] public void Test78()
    {
        string test25 = "4.091/(23.04/1.075/42.8)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
     ...
     [Fact] public void Test79()
    {
        string test25 = "(7068./33.59/9.13-4)/43.5";
        Model m = new Model(test25);
        double r25 = m.Calculate();
     ...
     [Fact] public void Test80()
    {
        string test25 = "97.66/(705.2/2619.)/59.59";
        Model m = new Model(test25); /// 97.66 705.2 2619. / / 59.59 /
        double r25 = m.Calculate();
    ...
    [Fact] public void Test83()
    {
     ...
     [Fact] public void Test84()
    {
        string test25 = "65991.*(0.5312*5213.)*(0.9450*897643)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
     ...
     [Fact] public void Test86()
    {
     ...
     [Fact] public void Test87()
    {
        string test25 = "(4^10)^3";
        Model m = new Model(test25);
        double r25 = m.Calculate();
     ...
     [Fact] public void Test89()
    {
     ...
     [Fact] public void Test90()
    {
        string test25 = "(45.34mod55.23)mod79.4";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    {
        string test25 = "499.23mod(1.8mod0.27)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
     ...
     [Fact] public void Test103()
    {
        string test25 = "(72*533+(-615))";
        Model m = new Model(test25);
        double r25 = m.Calculate();
     ...
     [Fact] public void Test104()
    {
        string test25 = "826-(738-243))";
        Model m = new Model(test25);
        double r25 = m.Calculate();
     ...
     [Fact] public void Test105()
    {
        string test25 = "17mod863*(-173";
        Model m = new Model(test25); /// 17 863 173 unar * %
        double r25 = m.Calculate();
        double cp25 = -2941;
        Assert.Equal(r25, cp25, 6);
    }
     ...
     [Fact] public void Test106()
    {
        string test25 = "40.34*(-0.424/(-252)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test109()
    {
        string test25 = "cos(-1.34)+tan(2.0)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
     ...
     [Fact] public void Test110()
    {
        string test25 = "(-(asin(0.3465346)/2)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test111()
    {
        string test25 = "atan(1.302+0.5)-1.2";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test112()
    {
        string test25 = "123modsqrt(100)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test113()
    {
        string test25 = "ln(256-3)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test114()
    {
        string test25 = "log(123.345)";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test115()
    {
        string test25 = "(-sin(13.4+atan(7)*56.4-17/4)*(cos(tan(2^4)))";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test116()
    {
        string test25 = "34.4+34/3";
        Model m = new Model(test25);
        double r25 = m.Calculate();
    ...
    [Fact] public void Test117()
    {
        string test25 = "34/0.4+5";
        Model m = new Model(test25);
        double r25 = m.Calculate();
